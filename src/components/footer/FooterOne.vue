            ...
            <div class="footer-up">
                <div class="row gy-5">
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <router-link class="logo" to="/"><img src="/assets/img/logo-2.png" alt="logo"></router-link>
                        <p>Nudimo napredna rješenja grijanja<br> osmišljena za udobnost, učinkovitost i dugoročnu
                            pouzdanost.
                        </p>
                    </div>
